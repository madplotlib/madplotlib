...
void test3()
{
    ...
    plt.axis(0, 25, 0, 14);
    plt.plot(x, y, QString("--"), QString("label=Dashed Line"));
    plt.plot(x, y+5, QString("label=Default Line"), (quint32)4);
...
void test6()
{
    ...
    Madplotlib plt;
    plt.plot(x, y, QColor(0xFF2700));               // red
    plt.plot(x, y, QString("o"), QColor(0xFF2700));
    plt.plot(x, y-40, QColor(0x008FD5));            // blue
    plt.plot(x, y-40, QString("o"), QColor(0x008FD5));
...
void test8()
{
    ...
    plt.axis("off");
    plt.plot(x, x.sqrt(), QColor(0, 0, 0));
    plt.plot(x, -x.sqrt(), QColor(0, 0, 0));
